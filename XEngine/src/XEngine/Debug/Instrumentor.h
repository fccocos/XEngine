...
#define XE_PROFILE_SCOPE_LINE2(name, line) constexpr auto fixedName##line = ::XEngine::InstrumentorUtils::CleanupOutputString(name, "__cdecl ");\
											   ::XEngine::InstrumentationTimer timer##line(fixedName##line.Data)
#define XE_PROFILE_SCOPE_LINE(name, line) XE_PROFILE_SCOPE_LINE2(name, line)
#define XE_PROFILE_SCOPE(name) XE_PROFILE_SCOPE_LINE(name, __LINE__)
